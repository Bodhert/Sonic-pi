defmodule RemoteDirector.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {RemoteDirector.Worker, arg},
      # Start to serve requests, typically the last entry
      RemoteDirectorWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: RemoteDirector.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    RemoteDirectorWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
